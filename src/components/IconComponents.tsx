...
// Define uma interface para as propriedades dos ícones, permitindo passar um className opcional.
interface IconProps {
    className?: string;
}

// A seguir, uma série de componentes funcionais (FC) que retornam ícones SVG.
// Cada componente aceita 'className' para permitir estilização customizada via Tailwind CSS.
